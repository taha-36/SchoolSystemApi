...
{
    public class RegisterTeacherHandler : IRequestHandler<RegisterTeacherCommand, Result<GetUserDto>>
    {
        private readonly AppDbContext dbContext;
        private readonly PasswordHasher<User> Hasher = new PasswordHasher<User>();
        public RegisterTeacherHandler(AppDbContext dbContext)
        {
            this.dbContext = dbContext;
        }
        public async Task<Result<GetUserDto>> Handle(RegisterTeacherCommand request, CancellationToken cancellationToken)
        {
